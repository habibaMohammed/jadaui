...
(function() {
    ...
    angular
        ...
        .controller('cModalController', cModalController);

    cModalController.$inject = ['$uibModal'];
    function cModalController($uibModal) {
        var vm = this;
 ...
 vm.showStatutory= function (size) {
        ...
        vm.display= function (size) {
          ...
          ModalInstanceCtrl.$inject = ['$scope', '$uibModalInstance','CompanyInfoService'];
          function ModalInstanceCtrl($scope, $uibModalInstance, CompanyInfoService) {
            ...
            $scope.Company=new CompanyInfoService();
